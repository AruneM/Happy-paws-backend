...
router.post('/shelter/signup', (req, res) => {
    const {full_name, email, passwordHash, shelter_name, location, description, url} = req.body;
    // console.log(username, email, password);
    
    // if any field is left empty
    if (!full_name || !email || !passwordHash || !shelter_name || !location || !description || !url) {
        res.status(500)
          .json({
